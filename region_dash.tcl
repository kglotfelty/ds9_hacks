...
$ds9(main).hack.quick.dashes.at.m add command -label "1" -command "my_change_dash 0 32767 1" \
    -image [lindex $regdash_icons 0]

# Surely there is a better array|list|loop mechanism I could use here,
# but it works.

$ds9(main).hack.quick.dashes.at.m add command -label "2" -command "my_change_dash 1 2 2" \
    -image [lindex $regdash_icons 1]
$ds9(main).hack.quick.dashes.at.m add command -label "3" -command "my_change_dash 2 2 4" \
    -image [lindex $regdash_icons 2]
$ds9(main).hack.quick.dashes.at.m add command -label "4" -command "my_change_dash 3 2 6" \
    -image [lindex $regdash_icons 3]
$ds9(main).hack.quick.dashes.at.m add command -label "4" -command "my_change_dash 4 2 8" \
    -image [lindex $regdash_icons 4]
$ds9(main).hack.quick.dashes.at.m add command -label "4" -command "my_change_dash 5 2 10" \
    -image [lindex $regdash_icons 5]

$ds9(main).hack.quick.dashes.at.m add command -label "2" -command "my_change_dash 6 8 2" \
    -image [lindex $regdash_icons 6]
$ds9(main).hack.quick.dashes.at.m add command -label "3" -command "my_change_dash 7 8 4" \
    -image [lindex $regdash_icons 7]
$ds9(main).hack.quick.dashes.at.m add command -label "4" -command "my_change_dash 8 8 6" \
    -image [lindex $regdash_icons 8]
$ds9(main).hack.quick.dashes.at.m add command -label "4" -command "my_change_dash 8 8 8" \
    -image [lindex $regdash_icons 9]
$ds9(main).hack.quick.dashes.at.m add command -label "4" -command "my_change_dash 10 8 10" \
    -image [lindex $regdash_icons 10]

$ds9(main).hack.quick.dashes.at.m add command -label "2" -command "my_change_dash 11 6 2" \
    -image [lindex $regdash_icons 11]
$ds9(main).hack.quick.dashes.at.m add command -label "3" -command "my_change_dash 12 6 4" \
    -image [lindex $regdash_icons 12]
$ds9(main).hack.quick.dashes.at.m add command -label "4" -command "my_change_dash 13 6 6" \
    -image [lindex $regdash_icons 13]
$ds9(main).hack.quick.dashes.at.m add command -label "4" -command "my_change_dash 14 6 8" \
    -image [lindex $regdash_icons 14]
$ds9(main).hack.quick.dashes.at.m add command -label "4" -command "my_change_dash 15 6 10" \
    -image [lindex $regdash_icons 15]

$ds9(main).hack.quick.dashes.at.m add command -label "2" -command "my_change_dash 16 8 2" \
    -image [lindex $regdash_icons 16]
$ds9(main).hack.quick.dashes.at.m add command -label "3" -command "my_change_dash 17 8 4" \
    -image [lindex $regdash_icons 17]
$ds9(main).hack.quick.dashes.at.m add command -label "4" -command "my_change_dash 18 8 6" \
    -image [lindex $regdash_icons 18]
$ds9(main).hack.quick.dashes.at.m add command -label "4" -command "my_change_dash 19 8 8" \
    -image [lindex $regdash_icons 19]
$ds9(main).hack.quick.dashes.at.m add command -label "4" -command "my_change_dash 20 8 10" \
    -image [lindex $regdash_icons 20]

$ds9(main).hack.quick.dashes.at.m add command -label "2" -command "my_change_dash 21 10 2" \
    -image [lindex $regdash_icons 21]
$ds9(main).hack.quick.dashes.at.m add command -label "3" -command "my_change_dash 22 10 4" \
    -image [lindex $regdash_icons 22]
$ds9(main).hack.quick.dashes.at.m add command -label "4" -command "my_change_dash 23 10 6" \
    -image [lindex $regdash_icons 23]
$ds9(main).hack.quick.dashes.at.m add command -label "4" -command "my_change_dash 24 10 8" \
    -image [lindex $regdash_icons 24]
$ds9(main).hack.quick.dashes.at.m add command -label "4" -command "my_change_dash 25 10 10" \
    -image [lindex $regdash_icons 25]


grid $ds9(main).hack.quick.dashes.at -row 0 -column 0
