...
button $ds9(main).quick.colors.blk -text {Back} -relief flat -bd 0 -takefocus 0 -command { my_change_color black } \
    -image [image create photo -file "$ds9_hack_root/UI/blk.png"] -padx 0 -pady 0 -highlightthickness 0 -overrelief flat
button $ds9(main).quick.colors.wht -text {Back} -relief flat -bd 0  -takefocus 0 -command { my_change_color white } \
    -image [image create photo -file "$ds9_hack_root/UI/wht.png"] -padx 0 -pady 0 -highlightthickness 0 -overrelief flat
button $ds9(main).quick.colors.red -text {Back} -relief flat -bd 0  -takefocus 0 -command { my_change_color red } \
    -image [image create photo -file "$ds9_hack_root/UI/red.png"] -padx 0 -pady 0 -highlightthickness 0 -overrelief flat
button $ds9(main).quick.colors.grn -text {Back} -relief flat -bd 0  -takefocus 0 -command { my_change_color green } \
    -image [image create photo -file "$ds9_hack_root/UI/grn.png"] -padx 0 -pady 0 -highlightthickness 0 -overrelief flat
button $ds9(main).quick.colors.blu -text {Back} -relief flat -bd 0  -takefocus 0 -command { my_change_color blue } \
    -image [image create photo -file "$ds9_hack_root/UI/blu.png"] -padx 0 -pady 0 -highlightthickness 0 -overrelief flat
button $ds9(main).quick.colors.cyn -text {Back} -relief flat -bd 0  -takefocus 0 -command { my_change_color cyan } \
    -image [image create photo -file "$ds9_hack_root/UI/cyn.png"] -padx 0 -pady 0 -highlightthickness 0 -overrelief flat
button $ds9(main).quick.colors.pur -text {Back} -relief flat -bd 0  -takefocus 0 -command { my_change_color magenta } \
    -image [image create photo -file "$ds9_hack_root/UI/pur.png"] -padx 0 -pady 0 -highlightthickness 0 -overrelief flat
button $ds9(main).quick.colors.yel -text {Back} -relief flat -bd 0  -takefocus 0 -command { my_change_color yellow } \
    -image [image create photo -file "$ds9_hack_root/UI/yel.png"] -padx 0 -pady 0 -highlightthickness 0 -overrelief flat


grid $ds9(main).quick.colors.blk -row 0 -column 0 -padx 0 -pady 0 -ipadx 0 -ipady 0
