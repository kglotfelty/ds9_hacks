...
ttk::frame $ds9(main).quick.state
grid $ds9(main).quick.state -row 0 -column $atcol -padx 5
incr atcol

ttk::button $ds9(main).quick.state.src -text {S/B} -takefocus 0 -command {my_change_srcbkg} \
    -image [image create photo -file "$ds9_hack_root/UI/srcbkg.png"]
ttk::button $ds9(main).quick.state.inc -text {I/E} -takefocus 0 -command {my_change_incexl} \
