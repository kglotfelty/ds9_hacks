ttk::frame $ds9(main).quick.layer
grid $ds9(main).quick.layer -row 0 -column $atcol -columnspan 1 -padx 5
incr atcol
ttk::button $ds9(main).quick.layer.back -text {Back} -takefocus 0 -command {MarkerBack } \
    -image [image create photo -file "$ds9_hack_root/UI/back.png"]
ttk::button $ds9(main).quick.layer.front -text {Front} -takefocus 0 -command {MarkerFront} \
